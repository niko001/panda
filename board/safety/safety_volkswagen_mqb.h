...
const SteeringLimits VOLKSWAGEN_MQB_STEERING_LIMITS = {
  ...
  .max_rate_up = 1536,          // 5.0 Nm/s RoC limit (EPS rack has own soft-limit of 5.0 Nm/s)
...
static safety_config volkswagen_mqb_init(uint16_t param) {
  ...
  if (volkswagen_longitudinal) {
    ...
    return BUILD_SAFETY_CFG(volkswagen_mqb_rx_checks, VOLKSWAGEN_MQB_STOCK_TX_MSGS);
  }
}
